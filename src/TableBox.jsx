    ...
    <>
      <>
        <Paper style={{ marginTop: "50px" }} elevation={10}>
          <TableContainer>
            <Typography component="p" variant="h6" style={{ padding: "20px" }}>
              Calibration report
            </Typography>
            <Table
            ...
            >
              ...
              <TableBody>
                <TableRow>
                  <TableCell className={classes.OneRow} align="right">
                    04.10.19
                    <br />
                    10:23
                  </TableCell>
                  <TableCell className={classes.solution} align="right">
                  ...
                  <TableCell className={classes.user} align="right">
                    Иванов Генадий Петрович
                  </TableCell>
                </TableRow>
